...
class SiameseModel:
    ...
    def add_conv2d_block(self, net, filters, kernel_size, add_max_pool=False):
    ...
    def build(self):
        ...
        self.add_conv2d_block(net, filters=64, kernel_size=(10, 10), add_max_pool=True)
        self.add_conv2d_block(net, filters=128, kernel_size=(7, 7), add_max_pool=True)
        self.add_conv2d_block(net, filters=128, kernel_size=(4, 4), add_max_pool=True)
        self.add_conv2d_block(net, filters=256, kernel_size=(4, 4), add_max_pool=False)
